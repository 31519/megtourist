  ...
  return (
    <>
      ...
      <div className={style.container}>
        ...
        <p>Welcome to meghalayaspot!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Meghalaya Spot Website, located at www.meghalayaspot.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use meghalayaspot if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing meghalayaspot, you agreed
          to use cookies in agreement with the Meghalaya Spot Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Meghalaya Spot and/or its licensors own the
          intellectual property rights for all material on meghalayaspot. All
          intellectual property rights are reserved. You may access this from
          meghalayaspot for your own personal use subjected to restrictions set
          in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from meghalayaspot</li>
          <li>Sell, rent or sub-license material from meghalayaspot</li>
          <li>Reproduce, duplicate or copy material from meghalayaspot</li>
          <li>Redistribute content from meghalayaspot</li>
        </ul>
        ...
        <p>
          ...
          Meghalaya Spot does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Meghalaya Spot,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Meghalaya Spot
        ...
        <p>
          Meghalaya Spot reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Meghalaya Spot a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Meghalaya Spot; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Meghalaya Spot. Please include your name, your
        ...
        <p>
          No use of Meghalaya Spot logo or other artwork will be allowed for
