...
import styles from "./MainviewDestination.module.css";
import { Grid } from "@mui/material";

function MainviewDestination({ datas }) {
  return (
    <>
      <Grid container className={styles.container}>
        <div className={styles.headerDiv}>
          <p className={styles.header}> Popular Destinations</p>
        </div>
        {datas &&
          datas.map((data) => (
            <Grid
...
export default MainviewDestination;
